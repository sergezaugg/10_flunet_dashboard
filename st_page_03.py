...
with st.sidebar:
    ...
    plot_height = st.slider("Plot height", min_value=300, max_value=2000, value = 600, step=100) 
    area_cutoff = st.slider("Area cutoff", min_value=0, max_value=1000, value=50, step=10) 
